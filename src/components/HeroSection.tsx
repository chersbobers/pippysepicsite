      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        <div className="bg-white/70 backdrop-blur-lg rounded-xl shadow-2xl px-8 py-10 border-4 border-green-300 flex flex-col items-center">
          <div className="inline-block mb-6 pixel-borders bg-green-300 p-2 transform -rotate-2 shadow-md">
            <h1 className="text-4xl md:text-6xl font-extrabold pixel-text text-green-800 drop-shadow-lg font-mono">
              PippyOC
            </h1>
          </div>
          <p className="text-lg md:text-2xl mb-8 max-w-2xl mx-auto pixel-text text-green-800 bg-green-200 inline-block p-4 pixel-borders rounded-lg shadow font-mono">
            Obby Creator Addict
          </p>
          <a
            ...
            className="bg-red-500 hover:bg-red-600 transition text-white font-bold py-3 px-8 rounded-lg pixel-button pixel-text text-base shadow-lg hover:scale-105 transform transition-transform duration-200"
          >
            View my channel
          </a>
        </div>
